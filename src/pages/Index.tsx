...
const Index = () => {
    ...
    return <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 flex items-center justify-center">
        <div className="text-center space-y-4">
          <div className="flex items-center justify-center space-x-3">
            <img src="/lovable-uploads/1aff2475-2ece-414b-ad8c-e62f839d0063.png" alt="HourForge Logo" className="w-12 h-12 object-contain animate-pulse" />
  ...
  return <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 pb-20">
